%% SCORPIUS Missile - Unit Production Costs

% Cost Model References: Tactical Missile Design {AIAA} Textbook

clearvars; clc; close all;

W_Launch = 1322; % Launch Weight, No Warhead Accounted For, lbs
...
fprintf('Unit #1 Production Cost = $%0.2f\n', C1st_value)
...
text(number_of_units_to_hit_500k - 1100, 600000, ...
    sprintf('  %.0f Units @ $500k', number_of_units_to_hit_500k), ...
    'VerticalAlignment','bottom')

text(11000, 650000, '  $500,000 Target', ...
    'VerticalAlignment','bottom', 'Color','red')

% Axes labels
xlabel('Number of Units Produced')
ylabel('Unit Production Cost ($)')
title('Scorpius Unit Production Cost - Constant Baseline Production')
...
%% Cost Curve - Surge Initial 2 Years
